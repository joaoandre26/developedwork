...
%% 
% Receiving uC data
path = 'C:\Users\JoaoAndre\Documents\masterthesis\RecordedTests\OneDrive - Universidade de Aveiro\Tests07_01_2021\';
...
savePath = strcat(path, circPath(3,:), MeasPath(1,:),bottlePath(1,:));
