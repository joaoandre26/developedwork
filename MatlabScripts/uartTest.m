...
currsignalPath = 'C:\Users\JoaoAndre\Documents\masterthesis\signalsAndData\Signals\Synthetized\signal';
readinfoPath = 'C:\Users\JoaoAndre\Documents\masterthesis\signalsAndData\Info\FixeduCImp.txt';
...
i=0;
while i<10
    Data = csvread(strcat(currsignalPath, num2str(i),'.txt'));
    j=0;
    while(j<BUFF_SIZE)
...
if exist(readinfoPath)==2
    ...
    csvwrite(readinfoPath, [eData; excData]);
else
    csvwrite(readinfoPath, excData);
end